...
void* NSSplitViewItem_type_Alloc() {
	return [NSSplitViewItem
		alloc];
}
void* NSSplitViewItem_type_SidebarWithViewController(void* viewController) {
	return [NSSplitViewItem
		sidebarWithViewController: viewController];
}
void* NSSplitViewItem_type_ContentListWithViewController(void* viewController) {
	return [NSSplitViewItem
		contentListWithViewController: viewController];
}
void* NSSplitViewItem_type_SplitViewItemWithViewController(void* viewController) {
	return [NSSplitViewItem
		splitViewItemWithViewController: viewController];
}
void* NSSplitViewItem_type_InspectorWithViewController(void* viewController) {
	return [NSSplitViewItem
		inspectorWithViewController: viewController];
}
void* NSSplitViewController_type_Alloc() {
	return [NSSplitViewController
		alloc];
}
void* NSToolbarItem_type_Alloc() {
	return [NSToolbarItem
		alloc];
}
void* NSToolbar_type_Alloc() {
	return [NSToolbar
		alloc];
}
void* NSSegmentedCell_type_Alloc() {
...
void* NSWindow_inst_Toolbar(void *id) {
	return [(NSWindow*)id
		toolbar];
}

void NSWindow_inst_SetToolbar(void *id, void* value) {
	[(NSWindow*)id
		setToolbar: value];
}
...
void* NSSplitViewItem_inst_Init(void *id) {
	return [(NSSplitViewItem*)id
		init];
}

double NSSplitViewItem_inst_AutomaticMaximumThickness(void *id) {
	return [(NSSplitViewItem*)id
		automaticMaximumThickness];
}

void NSSplitViewItem_inst_SetAutomaticMaximumThickness(void *id, double value) {
	[(NSSplitViewItem*)id
		setAutomaticMaximumThickness: value];
}

double NSSplitViewItem_inst_PreferredThicknessFraction(void *id) {
	return [(NSSplitViewItem*)id
		preferredThicknessFraction];
}

void NSSplitViewItem_inst_SetPreferredThicknessFraction(void *id, double value) {
	[(NSSplitViewItem*)id
		setPreferredThicknessFraction: value];
}

double NSSplitViewItem_inst_MinimumThickness(void *id) {
	return [(NSSplitViewItem*)id
		minimumThickness];
}

void NSSplitViewItem_inst_SetMinimumThickness(void *id, double value) {
	[(NSSplitViewItem*)id
		setMinimumThickness: value];
}

double NSSplitViewItem_inst_MaximumThickness(void *id) {
	return [(NSSplitViewItem*)id
		maximumThickness];
}

void NSSplitViewItem_inst_SetMaximumThickness(void *id, double value) {
	[(NSSplitViewItem*)id
		setMaximumThickness: value];
}

BOOL NSSplitViewItem_inst_IsCollapsed(void *id) {
	return [(NSSplitViewItem*)id
		isCollapsed];
}

void NSSplitViewItem_inst_SetCollapsed(void *id, BOOL value) {
	[(NSSplitViewItem*)id
		setCollapsed: value];
}

BOOL NSSplitViewItem_inst_CanCollapse(void *id) {
	return [(NSSplitViewItem*)id
		canCollapse];
}

void NSSplitViewItem_inst_SetCanCollapse(void *id, BOOL value) {
	[(NSSplitViewItem*)id
		setCanCollapse: value];
}

BOOL NSSplitViewItem_inst_IsSpringLoaded(void *id) {
	return [(NSSplitViewItem*)id
		isSpringLoaded];
}

void NSSplitViewItem_inst_SetSpringLoaded(void *id, BOOL value) {
	[(NSSplitViewItem*)id
		setSpringLoaded: value];
}

BOOL NSSplitViewItem_inst_CanCollapseFromWindowResize(void *id) {
	return [(NSSplitViewItem*)id
		canCollapseFromWindowResize];
}

void NSSplitViewItem_inst_SetCanCollapseFromWindowResize(void *id, BOOL value) {
	[(NSSplitViewItem*)id
		setCanCollapseFromWindowResize: value];
}

BOOL NSSplitViewItem_inst_AllowsFullHeightLayout(void *id) {
	return [(NSSplitViewItem*)id
		allowsFullHeightLayout];
}

void NSSplitViewItem_inst_SetAllowsFullHeightLayout(void *id, BOOL value) {
	[(NSSplitViewItem*)id
		setAllowsFullHeightLayout: value];
}

void* NSSplitViewItem_inst_ViewController(void *id) {
	return [(NSSplitViewItem*)id
		viewController];
}

void NSSplitViewItem_inst_SetViewController(void *id, void* value) {
	[(NSSplitViewItem*)id
		setViewController: value];
}

void NSSplitViewController_inst_AddSplitViewItem(void *id, void* splitViewItem) {
	[(NSSplitViewController*)id
		addSplitViewItem: splitViewItem];
}

void NSSplitViewController_inst_InsertSplitViewItemAtIndex(void *id, void* splitViewItem, long index) {
	[(NSSplitViewController*)id
		insertSplitViewItem: splitViewItem
		atIndex: index];
}

void NSSplitViewController_inst_RemoveSplitViewItem(void *id, void* splitViewItem) {
	[(NSSplitViewController*)id
		removeSplitViewItem: splitViewItem];
}

void* NSSplitViewController_inst_SplitViewItemForViewController(void *id, void* viewController) {
	return [(NSSplitViewController*)id
		splitViewItemForViewController: viewController];
}

void NSSplitViewController_inst_ToggleInspector(void *id, void* sender) {
	[(NSSplitViewController*)id
		toggleInspector: sender];
}

void NSSplitViewController_inst_ToggleSidebar(void *id, void* sender) {
	[(NSSplitViewController*)id
		toggleSidebar: sender];
}

void NSSplitViewController_inst_ViewDidLoad(void *id) {
	[(NSSplitViewController*)id
		viewDidLoad];
}

void* NSSplitViewController_inst_Init(void *id) {
	return [(NSSplitViewController*)id
		init];
}

void* NSSplitViewController_inst_SplitViewItems(void *id) {
	return [(NSSplitViewController*)id
		splitViewItems];
}

void NSSplitViewController_inst_SetSplitViewItems(void *id, void* value) {
	[(NSSplitViewController*)id
		setSplitViewItems: value];
}

double NSSplitViewController_inst_MinimumThicknessForInlineSidebars(void *id) {
	return [(NSSplitViewController*)id
		minimumThicknessForInlineSidebars];
}

void NSSplitViewController_inst_SetMinimumThicknessForInlineSidebars(void *id, double value) {
	[(NSSplitViewController*)id
		setMinimumThicknessForInlineSidebars: value];
}

void NSToolbarItem_inst_Validate(void *id) {
	[(NSToolbarItem*)id
		validate];
}

void* NSToolbarItem_inst_Init(void *id) {
	return [(NSToolbarItem*)id
		init];
}

void* NSToolbarItem_inst_Label(void *id) {
	return [(NSToolbarItem*)id
		label];
}

void NSToolbarItem_inst_SetLabel(void *id, void* value) {
	[(NSToolbarItem*)id
		setLabel: value];
}

void* NSToolbarItem_inst_PaletteLabel(void *id) {
	return [(NSToolbarItem*)id
		paletteLabel];
}

void NSToolbarItem_inst_SetPaletteLabel(void *id, void* value) {
	[(NSToolbarItem*)id
		setPaletteLabel: value];
}

void* NSToolbarItem_inst_Title(void *id) {
	return [(NSToolbarItem*)id
		title];
}

void NSToolbarItem_inst_SetTitle(void *id, void* value) {
	[(NSToolbarItem*)id
		setTitle: value];
}

void* NSToolbarItem_inst_ToolTip(void *id) {
	return [(NSToolbarItem*)id
		toolTip];
}

void NSToolbarItem_inst_SetToolTip(void *id, void* value) {
	[(NSToolbarItem*)id
		setToolTip: value];
}

void* NSToolbarItem_inst_Image(void *id) {
	return [(NSToolbarItem*)id
		image];
}

void NSToolbarItem_inst_SetImage(void *id, void* value) {
	[(NSToolbarItem*)id
		setImage: value];
}

void* NSToolbarItem_inst_View(void *id) {
	return [(NSToolbarItem*)id
		view];
}

void NSToolbarItem_inst_SetView(void *id, void* value) {
	[(NSToolbarItem*)id
		setView: value];
}

void* NSToolbarItem_inst_Target(void *id) {
	return [(NSToolbarItem*)id
		target];
}

void NSToolbarItem_inst_SetTarget(void *id, void* value) {
	[(NSToolbarItem*)id
		setTarget: value];
}

void* NSToolbarItem_inst_Action(void *id) {
	return [(NSToolbarItem*)id
		action];
}

void NSToolbarItem_inst_SetAction(void *id, void* value) {
	[(NSToolbarItem*)id
		setAction: value];
}

void* NSToolbarItem_inst_MenuFormRepresentation(void *id) {
	return [(NSToolbarItem*)id
		menuFormRepresentation];
}

void NSToolbarItem_inst_SetMenuFormRepresentation(void *id, void* value) {
	[(NSToolbarItem*)id
		setMenuFormRepresentation: value];
}

BOOL NSToolbarItem_inst_IsVisible(void *id) {
	return [(NSToolbarItem*)id
		isVisible];
}

BOOL NSToolbarItem_inst_IsBordered(void *id) {
	return [(NSToolbarItem*)id
		isBordered];
}

void NSToolbarItem_inst_SetBordered(void *id, BOOL value) {
	[(NSToolbarItem*)id
		setBordered: value];
}

BOOL NSToolbarItem_inst_IsNavigational(void *id) {
	return [(NSToolbarItem*)id
		isNavigational];
}

void NSToolbarItem_inst_SetNavigational(void *id, BOOL value) {
	[(NSToolbarItem*)id
		setNavigational: value];
}

BOOL NSToolbarItem_inst_IsEnabled(void *id) {
	return [(NSToolbarItem*)id
		isEnabled];
}

void NSToolbarItem_inst_SetEnabled(void *id, BOOL value) {
	[(NSToolbarItem*)id
		setEnabled: value];
}

BOOL NSToolbarItem_inst_AllowsDuplicatesInToolbar(void *id) {
	return [(NSToolbarItem*)id
		allowsDuplicatesInToolbar];
}

long NSToolbarItem_inst_Tag(void *id) {
	return [(NSToolbarItem*)id
		tag];
}

void NSToolbarItem_inst_SetTag(void *id, long value) {
	[(NSToolbarItem*)id
		setTag: value];
}

void* NSToolbarItem_inst_Toolbar(void *id) {
	return [(NSToolbarItem*)id
		toolbar];
}

BOOL NSToolbarItem_inst_Autovalidates(void *id) {
	return [(NSToolbarItem*)id
		autovalidates];
}

void NSToolbarItem_inst_SetAutovalidates(void *id, BOOL value) {
	[(NSToolbarItem*)id
		setAutovalidates: value];
}

void* NSToolbar_inst_Init(void *id) {
	return [(NSToolbar*)id
		init];
}

void NSToolbar_inst_RemoveItemAtIndex(void *id, long index) {
	[(NSToolbar*)id
		removeItemAtIndex: index];
}

void NSToolbar_inst_RunCustomizationPalette(void *id, void* sender) {
	[(NSToolbar*)id
		runCustomizationPalette: sender];
}

void NSToolbar_inst_SetConfigurationFromDictionary(void *id, void* configDict) {
	[(NSToolbar*)id
		setConfigurationFromDictionary: configDict];
}

void NSToolbar_inst_ValidateVisibleItems(void *id) {
	[(NSToolbar*)id
		validateVisibleItems];
}

void* NSToolbar_inst_Delegate(void *id) {
	return [(NSToolbar*)id
		delegate];
}

void NSToolbar_inst_SetDelegate(void *id, void* value) {
	[(NSToolbar*)id
		setDelegate: value];
}

BOOL NSToolbar_inst_IsVisible(void *id) {
	return [(NSToolbar*)id
		isVisible];
}

void NSToolbar_inst_SetVisible(void *id, BOOL value) {
	[(NSToolbar*)id
		setVisible: value];
}

BOOL NSToolbar_inst_ShowsBaselineSeparator(void *id) {
	return [(NSToolbar*)id
		showsBaselineSeparator];
}

void NSToolbar_inst_SetShowsBaselineSeparator(void *id, BOOL value) {
	[(NSToolbar*)id
		setShowsBaselineSeparator: value];
}

BOOL NSToolbar_inst_AllowsUserCustomization(void *id) {
	return [(NSToolbar*)id
		allowsUserCustomization];
}

void NSToolbar_inst_SetAllowsUserCustomization(void *id, BOOL value) {
	[(NSToolbar*)id
		setAllowsUserCustomization: value];
}

BOOL NSToolbar_inst_AllowsExtensionItems(void *id) {
	return [(NSToolbar*)id
		allowsExtensionItems];
}

void NSToolbar_inst_SetAllowsExtensionItems(void *id, BOOL value) {
	[(NSToolbar*)id
		setAllowsExtensionItems: value];
}

void* NSToolbar_inst_Items(void *id) {
	return [(NSToolbar*)id
		items];
}

void* NSToolbar_inst_VisibleItems(void *id) {
	return [(NSToolbar*)id
		visibleItems];
}

BOOL NSToolbar_inst_AutosavesConfiguration(void *id) {
	return [(NSToolbar*)id
		autosavesConfiguration];
}

void NSToolbar_inst_SetAutosavesConfiguration(void *id, BOOL value) {
	[(NSToolbar*)id
		setAutosavesConfiguration: value];
}

void* NSToolbar_inst_ConfigurationDictionary(void *id) {
	return [(NSToolbar*)id
		configurationDictionary];
}

BOOL NSToolbar_inst_CustomizationPaletteIsRunning(void *id) {
	return [(NSToolbar*)id
		customizationPaletteIsRunning];
}

void NSSegmentedCell_inst_DrawSegmentInFrameWithView(void *id, long segment, NSRect frame, void* controlView) {
	[(NSSegmentedCell*)id
		drawSegment: segment
		inFrame: frame
...
void* NSSegmentedCell_inst_ImageForSegment(void *id, long segment) {
	return [(NSSegmentedCell*)id
		imageForSegment: segment];
}

BOOL NSSegmentedCell_inst_IsEnabledForSegment(void *id, long segment) {
	return [(NSSegmentedCell*)id
		isEnabledForSegment: segment];
}

BOOL NSSegmentedCell_inst_IsSelectedForSegment(void *id, long segment) {
	return [(NSSegmentedCell*)id
		isSelectedForSegment: segment];
}

void* NSSegmentedCell_inst_LabelForSegment(void *id, long segment) {
	return [(NSSegmentedCell*)id
		labelForSegment: segment];
}

void NSSegmentedCell_inst_MakeNextSegmentKey(void *id) {
	[(NSSegmentedCell*)id
		makeNextSegmentKey];
}

void NSSegmentedCell_inst_MakePreviousSegmentKey(void *id) {
	[(NSSegmentedCell*)id
		makePreviousSegmentKey];
}

void* NSSegmentedCell_inst_MenuForSegment(void *id, long segment) {
	return [(NSSegmentedCell*)id
		menuForSegment: segment];
}

BOOL NSSegmentedCell_inst_SelectSegmentWithTag(void *id, long tag) {
	return [(NSSegmentedCell*)id
		selectSegmentWithTag: tag];
}

void NSSegmentedCell_inst_SetEnabledForSegment(void *id, BOOL enabled, long segment) {
	[(NSSegmentedCell*)id
		setEnabled: enabled
		forSegment: segment];
}

void NSSegmentedCell_inst_SetImageForSegment(void *id, void* image, long segment) {
	[(NSSegmentedCell*)id
		setImage: image
		forSegment: segment];
}

void NSSegmentedCell_inst_SetLabelForSegment(void *id, void* label, long segment) {
	[(NSSegmentedCell*)id
		setLabel: label
		forSegment: segment];
}

void NSSegmentedCell_inst_SetMenuForSegment(void *id, void* menu, long segment) {
	[(NSSegmentedCell*)id
		setMenu: menu
		forSegment: segment];
}

void NSSegmentedCell_inst_SetSelectedForSegment(void *id, BOOL selected, long segment) {
	[(NSSegmentedCell*)id
		setSelected: selected
		forSegment: segment];
}

void NSSegmentedCell_inst_SetTagForSegment(void *id, long tag, long segment) {
	[(NSSegmentedCell*)id
		setTag: tag
		forSegment: segment];
}

void NSSegmentedCell_inst_SetToolTipForSegment(void *id, void* toolTip, long segment) {
	[(NSSegmentedCell*)id
		setToolTip: toolTip
		forSegment: segment];
}

void NSSegmentedCell_inst_SetWidthForSegment(void *id, double width, long segment) {
	[(NSSegmentedCell*)id
		setWidth: width
		forSegment: segment];
}

long NSSegmentedCell_inst_TagForSegment(void *id, long segment) {
	return [(NSSegmentedCell*)id
		tagForSegment: segment];
}

void* NSSegmentedCell_inst_ToolTipForSegment(void *id, long segment) {
	return [(NSSegmentedCell*)id
		toolTipForSegment: segment];
}

double NSSegmentedCell_inst_WidthForSegment(void *id, long segment) {
	return [(NSSegmentedCell*)id
		widthForSegment: segment];
}

void* NSSegmentedCell_inst_Init(void *id) {
	return [(NSSegmentedCell*)id
		init];
}

long NSSegmentedCell_inst_SegmentCount(void *id) {
	return [(NSSegmentedCell*)id
		segmentCount];
}

void NSSegmentedCell_inst_SetSegmentCount(void *id, long value) {
	[(NSSegmentedCell*)id
		setSegmentCount: value];
}

long NSSegmentedCell_inst_SelectedSegment(void *id) {
	return [(NSSegmentedCell*)id
		selectedSegment];
}

void NSSegmentedCell_inst_SetSelectedSegment(void *id, long value) {
	[(NSSegmentedCell*)id
...
// NSSplitViewItem_Alloc is undocumented.
func NSSplitViewItem_Alloc() NSSplitViewItem {
	ret := C.NSSplitViewItem_type_Alloc()

	return NSSplitViewItem_FromPointer(ret)
}

// NSSplitViewItem_SidebarWithViewController creates a split view item that represents a sidebar for the specified view controller.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/1388920-sidebarwithviewcontroller?language=objc for details.
func NSSplitViewItem_SidebarWithViewController(viewController NSViewControllerRef) NSSplitViewItem {
	ret := C.NSSplitViewItem_type_SidebarWithViewController(
...
// NSSplitViewItem_ContentListWithViewController creates a split view item that represents a content list for the specified view controller.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/1388878-contentlistwithviewcontroller?language=objc for details.
func NSSplitViewItem_ContentListWithViewController(viewController NSViewControllerRef) NSSplitViewItem {
	ret := C.NSSplitViewItem_type_ContentListWithViewController(
		objc.RefPointer(viewController),
	)
...
// NSSplitViewItem_SplitViewItemWithViewController creates a split view item that represents the specified view controller.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/1388918-splitviewitemwithviewcontroller?language=objc for details.
func NSSplitViewItem_SplitViewItemWithViewController(viewController NSViewControllerRef) NSSplitViewItem {
	ret := C.NSSplitViewItem_type_SplitViewItemWithViewController(
		objc.RefPointer(viewController),
	)
...
// NSSplitViewItem_InspectorWithViewController is undocumented.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/4179467-inspectorwithviewcontroller?language=objc for details.
func NSSplitViewItem_InspectorWithViewController(viewController NSViewControllerRef) NSSplitViewItem {
	ret := C.NSSplitViewItem_type_InspectorWithViewController(
		objc.RefPointer(viewController),
	)
...
// NSSplitViewController_Alloc is undocumented.
func NSSplitViewController_Alloc() NSSplitViewController {
	ret := C.NSSplitViewController_type_Alloc()

	return NSSplitViewController_FromPointer(ret)
}

// NSToolbarItem_Alloc is undocumented.
func NSToolbarItem_Alloc() NSToolbarItem {
	ret := C.NSToolbarItem_type_Alloc()

	return NSToolbarItem_FromPointer(ret)
}

// NSToolbar_Alloc is undocumented.
func NSToolbar_Alloc() NSToolbar {
	ret := C.NSToolbar_type_Alloc()

	return NSToolbar_FromPointer(ret)
}

// NSSegmentedCell_Alloc is undocumented.
func NSSegmentedCell_Alloc() NSSegmentedCell {
	ret := C.NSSegmentedCell_type_Alloc()

	return NSSegmentedCell_FromPointer(ret)
}
...
//
// See https://developer.apple.com/documentation/appkit/nswindow/1419731-toolbar?language=objc for details.
func (x gen_NSWindow) Toolbar() NSToolbar {
	ret := C.NSWindow_inst_Toolbar(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetToolbar returns the window’s toolbar.
//
// See https://developer.apple.com/documentation/appkit/nswindow/1419731-toolbar?language=objc for details.
func (x gen_NSWindow) SetToolbar(
	value NSToolbarRef,
) {
	C.NSWindow_inst_SetToolbar(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(value),
	)
...
type NSSplitViewItemRef interface {
	Pointer() uintptr
	Init_AsNSSplitViewItem() NSSplitViewItem
}

type gen_NSSplitViewItem struct {
	objc.Object
}

func NSSplitViewItem_FromPointer(ptr unsafe.Pointer) NSSplitViewItem {
	return NSSplitViewItem{gen_NSSplitViewItem{
		objc.Object_FromPointer(ptr),
	}}
}

func NSSplitViewItem_FromRef(ref objc.Ref) NSSplitViewItem {
	return NSSplitViewItem_FromPointer(unsafe.Pointer(ref.Pointer()))
}

// Init initializes a new instance of the NSSplitViewItem class.
func (x gen_NSSplitViewItem) Init() NSSplitViewItem {
	ret := C.NSSplitViewItem_inst_Init(
		unsafe.Pointer(x.Pointer()),
	)
...
// Init_AsNSSplitViewItem is a typed version of Init.
func (x gen_NSSplitViewItem) Init_AsNSSplitViewItem() NSSplitViewItem {
	ret := C.NSSplitViewItem_inst_Init(
		unsafe.Pointer(x.Pointer()),
	)
...
// AutomaticMaximumThickness returns the maximum thickness of the split view item when it resizes due to automatic sizing.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/1388889-automaticmaximumthickness?language=objc for details.
func (x gen_NSSplitViewItem) AutomaticMaximumThickness() core.CGFloat {
	ret := C.NSSplitViewItem_inst_AutomaticMaximumThickness(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetAutomaticMaximumThickness returns the maximum thickness of the split view item when it resizes due to automatic sizing.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/1388889-automaticmaximumthickness?language=objc for details.
func (x gen_NSSplitViewItem) SetAutomaticMaximumThickness(
	value core.CGFloat,
) {
	C.NSSplitViewItem_inst_SetAutomaticMaximumThickness(
		unsafe.Pointer(x.Pointer()),
		C.double(value),
	)
...
// PreferredThicknessFraction returns the preferred thickness of the split view item relative to the split view.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/1388885-preferredthicknessfraction?language=objc for details.
func (x gen_NSSplitViewItem) PreferredThicknessFraction() core.CGFloat {
	ret := C.NSSplitViewItem_inst_PreferredThicknessFraction(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetPreferredThicknessFraction returns the preferred thickness of the split view item relative to the split view.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/1388885-preferredthicknessfraction?language=objc for details.
func (x gen_NSSplitViewItem) SetPreferredThicknessFraction(
	value core.CGFloat,
) {
	C.NSSplitViewItem_inst_SetPreferredThicknessFraction(
		unsafe.Pointer(x.Pointer()),
		C.double(value),
	)
...
// MinimumThickness returns the minimum thickness of the split view item.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/1388853-minimumthickness?language=objc for details.
func (x gen_NSSplitViewItem) MinimumThickness() core.CGFloat {
	ret := C.NSSplitViewItem_inst_MinimumThickness(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetMinimumThickness returns the minimum thickness of the split view item.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/1388853-minimumthickness?language=objc for details.
func (x gen_NSSplitViewItem) SetMinimumThickness(
	value core.CGFloat,
) {
	C.NSSplitViewItem_inst_SetMinimumThickness(
		unsafe.Pointer(x.Pointer()),
		C.double(value),
	)
...
// MaximumThickness returns the maximum thickness of the split view item.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/1388930-maximumthickness?language=objc for details.
func (x gen_NSSplitViewItem) MaximumThickness() core.CGFloat {
	ret := C.NSSplitViewItem_inst_MaximumThickness(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetMaximumThickness returns the maximum thickness of the split view item.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/1388930-maximumthickness?language=objc for details.
func (x gen_NSSplitViewItem) SetMaximumThickness(
	value core.CGFloat,
) {
	C.NSSplitViewItem_inst_SetMaximumThickness(
		unsafe.Pointer(x.Pointer()),
		C.double(value),
	)
...
// IsCollapsed returns a Boolean value that determines whether the child view controller that corresponds to the split view item is in a collapsed state in the split view controller.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/1388891-collapsed?language=objc for details.
func (x gen_NSSplitViewItem) IsCollapsed() bool {
	ret := C.NSSplitViewItem_inst_IsCollapsed(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetCollapsed returns a Boolean value that determines whether the child view controller that corresponds to the split view item is in a collapsed state in the split view controller.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/1388891-collapsed?language=objc for details.
func (x gen_NSSplitViewItem) SetCollapsed(
	value bool,
) {
	C.NSSplitViewItem_inst_SetCollapsed(
		unsafe.Pointer(x.Pointer()),
		convertToObjCBool(value),
	)
...
// CanCollapse returns a Boolean value that determines whether a user interaction can collapse the child view controller that corresponds to the split view item.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/1388926-cancollapse?language=objc for details.
func (x gen_NSSplitViewItem) CanCollapse() bool {
	ret := C.NSSplitViewItem_inst_CanCollapse(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetCanCollapse returns a Boolean value that determines whether a user interaction can collapse the child view controller that corresponds to the split view item.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/1388926-cancollapse?language=objc for details.
func (x gen_NSSplitViewItem) SetCanCollapse(
	value bool,
) {
	C.NSSplitViewItem_inst_SetCanCollapse(
		unsafe.Pointer(x.Pointer()),
		convertToObjCBool(value),
	)
...
// IsSpringLoaded returns a Boolean value that determines whether the split view item can temporarily expand during a drag.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/1388895-springloaded?language=objc for details.
func (x gen_NSSplitViewItem) IsSpringLoaded() bool {
	ret := C.NSSplitViewItem_inst_IsSpringLoaded(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetSpringLoaded returns a Boolean value that determines whether the split view item can temporarily expand during a drag.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/1388895-springloaded?language=objc for details.
func (x gen_NSSplitViewItem) SetSpringLoaded(
	value bool,
) {
	C.NSSplitViewItem_inst_SetSpringLoaded(
		unsafe.Pointer(x.Pointer()),
		convertToObjCBool(value),
	)
...
// CanCollapseFromWindowResize is undocumented.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/4179466-cancollapsefromwindowresize?language=objc for details.
func (x gen_NSSplitViewItem) CanCollapseFromWindowResize() bool {
	ret := C.NSSplitViewItem_inst_CanCollapseFromWindowResize(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetCanCollapseFromWindowResize is undocumented.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/4179466-cancollapsefromwindowresize?language=objc for details.
func (x gen_NSSplitViewItem) SetCanCollapseFromWindowResize(
	value bool,
) {
	C.NSSplitViewItem_inst_SetCanCollapseFromWindowResize(
		unsafe.Pointer(x.Pointer()),
		convertToObjCBool(value),
	)
...
// AllowsFullHeightLayout returns a Boolean value that indicates whether full-height sidebars appear in the window after you set a style mask.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/3608197-allowsfullheightlayout?language=objc for details.
func (x gen_NSSplitViewItem) AllowsFullHeightLayout() bool {
	ret := C.NSSplitViewItem_inst_AllowsFullHeightLayout(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetAllowsFullHeightLayout returns a Boolean value that indicates whether full-height sidebars appear in the window after you set a style mask.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/3608197-allowsfullheightlayout?language=objc for details.
func (x gen_NSSplitViewItem) SetAllowsFullHeightLayout(
	value bool,
) {
	C.NSSplitViewItem_inst_SetAllowsFullHeightLayout(
		unsafe.Pointer(x.Pointer()),
		convertToObjCBool(value),
	)
...
// ViewController returns the view controller that the split view item represents.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/1388911-viewcontroller?language=objc for details.
func (x gen_NSSplitViewItem) ViewController() NSViewController {
	ret := C.NSSplitViewItem_inst_ViewController(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetViewController returns the view controller that the split view item represents.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewitem/1388911-viewcontroller?language=objc for details.
func (x gen_NSSplitViewItem) SetViewController(
	value NSViewControllerRef,
) {
	C.NSSplitViewItem_inst_SetViewController(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(value),
	)
...
type NSSplitViewControllerRef interface {
	Pointer() uintptr
	Init_AsNSSplitViewController() NSSplitViewController
}

type gen_NSSplitViewController struct {
	NSViewController
}

func NSSplitViewController_FromPointer(ptr unsafe.Pointer) NSSplitViewController {
	return NSSplitViewController{gen_NSSplitViewController{
		NSViewController_FromPointer(ptr),
	}}
}

func NSSplitViewController_FromRef(ref objc.Ref) NSSplitViewController {
	return NSSplitViewController_FromPointer(unsafe.Pointer(ref.Pointer()))
}

// AddSplitViewItem adds a split view item to the end of the array of split view items.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewcontroller/1388928-addsplitviewitem?language=objc for details.
func (x gen_NSSplitViewController) AddSplitViewItem(
	splitViewItem NSSplitViewItemRef,
) {
	C.NSSplitViewController_inst_AddSplitViewItem(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(splitViewItem),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssplitviewcontroller/1388886-insertsplitviewitem?language=objc for details.
func (x gen_NSSplitViewController) InsertSplitViewItemAtIndex(
	splitViewItem NSSplitViewItemRef,
	index core.NSInteger,
) {
	C.NSSplitViewController_inst_InsertSplitViewItemAtIndex(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(splitViewItem),
		C.long(index),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssplitviewcontroller/1388903-removesplitviewitem?language=objc for details.
func (x gen_NSSplitViewController) RemoveSplitViewItem(
	splitViewItem NSSplitViewItemRef,
) {
	C.NSSplitViewController_inst_RemoveSplitViewItem(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(splitViewItem),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssplitviewcontroller/1388857-splitviewitemforviewcontroller?language=objc for details.
func (x gen_NSSplitViewController) SplitViewItemForViewController(
	viewController NSViewControllerRef,
) NSSplitViewItem {
	ret := C.NSSplitViewController_inst_SplitViewItemForViewController(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(viewController),
	)
...
// ToggleInspector is undocumented.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewcontroller/4179465-toggleinspector?language=objc for details.
func (x gen_NSSplitViewController) ToggleInspector(
	sender objc.Ref,
) {
	C.NSSplitViewController_inst_ToggleInspector(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(sender),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssplitviewcontroller/1388905-togglesidebar?language=objc for details.
func (x gen_NSSplitViewController) ToggleSidebar(
	sender objc.Ref,
) {
	C.NSSplitViewController_inst_ToggleSidebar(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(sender),
	)
...
// ViewDidLoad configures the split view controller after its view loads into memory.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewcontroller/1388874-viewdidload?language=objc for details.
func (x gen_NSSplitViewController) ViewDidLoad() {
	C.NSSplitViewController_inst_ViewDidLoad(
		unsafe.Pointer(x.Pointer()),
	)
...
// Init initializes a new instance of the NSSplitViewController class.
func (x gen_NSSplitViewController) Init() NSSplitViewController {
	ret := C.NSSplitViewController_inst_Init(
		unsafe.Pointer(x.Pointer()),
	)
...
// Init_AsNSSplitViewController is a typed version of Init.
func (x gen_NSSplitViewController) Init_AsNSSplitViewController() NSSplitViewController {
	ret := C.NSSplitViewController_inst_Init(
		unsafe.Pointer(x.Pointer()),
	)
...
// SplitViewItems returns the array of split view items that correspond to the split view controller’s child view controllers.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewcontroller/1388876-splitviewitems?language=objc for details.
func (x gen_NSSplitViewController) SplitViewItems() core.NSArray {
	ret := C.NSSplitViewController_inst_SplitViewItems(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetSplitViewItems returns the array of split view items that correspond to the split view controller’s child view controllers.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewcontroller/1388876-splitviewitems?language=objc for details.
func (x gen_NSSplitViewController) SetSplitViewItems(
	value core.NSArrayRef,
) {
	C.NSSplitViewController_inst_SetSplitViewItems(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(value),
	)
...
// MinimumThicknessForInlineSidebars returns the minimum thickness for a sidebar before it automatically collapses.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewcontroller/1388863-minimumthicknessforinlinesidebar?language=objc for details.
func (x gen_NSSplitViewController) MinimumThicknessForInlineSidebars() core.CGFloat {
	ret := C.NSSplitViewController_inst_MinimumThicknessForInlineSidebars(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetMinimumThicknessForInlineSidebars returns the minimum thickness for a sidebar before it automatically collapses.
//
// See https://developer.apple.com/documentation/appkit/nssplitviewcontroller/1388863-minimumthicknessforinlinesidebar?language=objc for details.
func (x gen_NSSplitViewController) SetMinimumThicknessForInlineSidebars(
	value core.CGFloat,
) {
	C.NSSplitViewController_inst_SetMinimumThicknessForInlineSidebars(
		unsafe.Pointer(x.Pointer()),
		C.double(value),
	)
...
type NSToolbarItemRef interface {
	Pointer() uintptr
	Init_AsNSToolbarItem() NSToolbarItem
}

type gen_NSToolbarItem struct {
	objc.Object
}

func NSToolbarItem_FromPointer(ptr unsafe.Pointer) NSToolbarItem {
	return NSToolbarItem{gen_NSToolbarItem{
		objc.Object_FromPointer(ptr),
	}}
}

func NSToolbarItem_FromRef(ref objc.Ref) NSToolbarItem {
	return NSToolbarItem_FromPointer(unsafe.Pointer(ref.Pointer()))
}

// Validate validates the toolbar item’s menu and its ability to perfrom its action.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1525295-validate?language=objc for details.
func (x gen_NSToolbarItem) Validate() {
	C.NSToolbarItem_inst_Validate(
		unsafe.Pointer(x.Pointer()),
	)
...
// Init initializes a new instance of the NSToolbarItem class.
func (x gen_NSToolbarItem) Init() NSToolbarItem {
	ret := C.NSToolbarItem_inst_Init(
		unsafe.Pointer(x.Pointer()),
	)
...
// Init_AsNSToolbarItem is a typed version of Init.
func (x gen_NSToolbarItem) Init_AsNSToolbarItem() NSToolbarItem {
	ret := C.NSToolbarItem_inst_Init(
		unsafe.Pointer(x.Pointer()),
	)
...
// Label returns the label that appears for this item in the toolbar.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1535127-label?language=objc for details.
func (x gen_NSToolbarItem) Label() core.NSString {
	ret := C.NSToolbarItem_inst_Label(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetLabel returns the label that appears for this item in the toolbar.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1535127-label?language=objc for details.
func (x gen_NSToolbarItem) SetLabel(
	value core.NSStringRef,
) {
	C.NSToolbarItem_inst_SetLabel(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(value),
	)
...
// PaletteLabel returns the label that appears when the toolbar item is in the customization palette.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1525421-palettelabel?language=objc for details.
func (x gen_NSToolbarItem) PaletteLabel() core.NSString {
	ret := C.NSToolbarItem_inst_PaletteLabel(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetPaletteLabel returns the label that appears when the toolbar item is in the customization palette.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1525421-palettelabel?language=objc for details.
func (x gen_NSToolbarItem) SetPaletteLabel(
	value core.NSStringRef,
) {
	C.NSToolbarItem_inst_SetPaletteLabel(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(value),
	)
...
// Title returns the title of the toolbar item.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/3237225-title?language=objc for details.
func (x gen_NSToolbarItem) Title() core.NSString {
	ret := C.NSToolbarItem_inst_Title(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetTitle returns the title of the toolbar item.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/3237225-title?language=objc for details.
func (x gen_NSToolbarItem) SetTitle(
	value core.NSStringRef,
) {
	C.NSToolbarItem_inst_SetTitle(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(value),
	)
...
// ToolTip returns the tooltip to display when someone hovers over the item in the toolbar.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1524627-tooltip?language=objc for details.
func (x gen_NSToolbarItem) ToolTip() core.NSString {
	ret := C.NSToolbarItem_inst_ToolTip(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetToolTip returns the tooltip to display when someone hovers over the item in the toolbar.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1524627-tooltip?language=objc for details.
func (x gen_NSToolbarItem) SetToolTip(
	value core.NSStringRef,
) {
	C.NSToolbarItem_inst_SetToolTip(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(value),
	)
...
// Image returns the image to display for the toolbar item.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1527749-image?language=objc for details.
func (x gen_NSToolbarItem) Image() NSImage {
	ret := C.NSToolbarItem_inst_Image(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetImage returns the image to display for the toolbar item.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1527749-image?language=objc for details.
func (x gen_NSToolbarItem) SetImage(
	value NSImageRef,
) {
	C.NSToolbarItem_inst_SetImage(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(value),
	)
...
// View returns the custom view you use to draw the toolbar item.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1534039-view?language=objc for details.
func (x gen_NSToolbarItem) View() NSView {
	ret := C.NSToolbarItem_inst_View(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetView returns the custom view you use to draw the toolbar item.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1534039-view?language=objc for details.
func (x gen_NSToolbarItem) SetView(
	value NSViewRef,
) {
	C.NSToolbarItem_inst_SetView(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(value),
	)
...
// Target returns the object that defines the action method the toolbar item calls when clicked.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1525982-target?language=objc for details.
func (x gen_NSToolbarItem) Target() objc.Object {
	ret := C.NSToolbarItem_inst_Target(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetTarget returns the object that defines the action method the toolbar item calls when clicked.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1525982-target?language=objc for details.
func (x gen_NSToolbarItem) SetTarget(
	value objc.Ref,
) {
	C.NSToolbarItem_inst_SetTarget(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(value),
	)
...
// Action returns the action method to call when someone clicks on the toolbar item.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1525723-action?language=objc for details.
func (x gen_NSToolbarItem) Action() objc.Selector {
	ret := C.NSToolbarItem_inst_Action(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetAction returns the action method to call when someone clicks on the toolbar item.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1525723-action?language=objc for details.
func (x gen_NSToolbarItem) SetAction(
	value objc.Selector,
) {
	C.NSToolbarItem_inst_SetAction(
		unsafe.Pointer(x.Pointer()),
		value.SelectorAddress(),
	)
...
// MenuFormRepresentation returns the menu item to use when the toolbar item is in the overflow menu.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1532562-menuformrepresentation?language=objc for details.
func (x gen_NSToolbarItem) MenuFormRepresentation() NSMenuItem {
	ret := C.NSToolbarItem_inst_MenuFormRepresentation(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetMenuFormRepresentation returns the menu item to use when the toolbar item is in the overflow menu.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1532562-menuformrepresentation?language=objc for details.
func (x gen_NSToolbarItem) SetMenuFormRepresentation(
	value NSMenuItemRef,
) {
	C.NSToolbarItem_inst_SetMenuFormRepresentation(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(value),
	)
...
// IsVisible returns a Boolean value that indicates whether the item is currently visible in the toolbar, and not in the overflow menu.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/3969244-visible?language=objc for details.
func (x gen_NSToolbarItem) IsVisible() bool {
	ret := C.NSToolbarItem_inst_IsVisible(
		unsafe.Pointer(x.Pointer()),
	)
...
// IsBordered returns a Boolean value that indicates whether the toolbar item has a bordered style.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/3237224-bordered?language=objc for details.
func (x gen_NSToolbarItem) IsBordered() bool {
	ret := C.NSToolbarItem_inst_IsBordered(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetBordered returns a Boolean value that indicates whether the toolbar item has a bordered style.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/3237224-bordered?language=objc for details.
func (x gen_NSToolbarItem) SetBordered(
	value bool,
) {
	C.NSToolbarItem_inst_SetBordered(
		unsafe.Pointer(x.Pointer()),
		convertToObjCBool(value),
	)
...
// IsNavigational returns a Boolean value that indicates whether the item behaves as a navigation item in the toolbar.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/3622481-navigational?language=objc for details.
func (x gen_NSToolbarItem) IsNavigational() bool {
	ret := C.NSToolbarItem_inst_IsNavigational(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetNavigational returns a Boolean value that indicates whether the item behaves as a navigation item in the toolbar.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/3622481-navigational?language=objc for details.
func (x gen_NSToolbarItem) SetNavigational(
	value bool,
) {
	C.NSToolbarItem_inst_SetNavigational(
		unsafe.Pointer(x.Pointer()),
		convertToObjCBool(value),
	)
...
// IsEnabled returns a Boolean value that indicates whether the item is enabled.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1524277-enabled?language=objc for details.
func (x gen_NSToolbarItem) IsEnabled() bool {
	ret := C.NSToolbarItem_inst_IsEnabled(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetEnabled returns a Boolean value that indicates whether the item is enabled.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1524277-enabled?language=objc for details.
func (x gen_NSToolbarItem) SetEnabled(
	value bool,
) {
	C.NSToolbarItem_inst_SetEnabled(
		unsafe.Pointer(x.Pointer()),
		convertToObjCBool(value),
	)
...
// AllowsDuplicatesInToolbar returns a Boolean value that indicates whether the toolbar item can appear more than once in a toolbar.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1530116-allowsduplicatesintoolbar?language=objc for details.
func (x gen_NSToolbarItem) AllowsDuplicatesInToolbar() bool {
	ret := C.NSToolbarItem_inst_AllowsDuplicatesInToolbar(
		unsafe.Pointer(x.Pointer()),
	)
...
// Tag an integer tag you can use to identify the toolbar item.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1524618-tag?language=objc for details.
func (x gen_NSToolbarItem) Tag() core.NSInteger {
	ret := C.NSToolbarItem_inst_Tag(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetTag an integer tag you can use to identify the toolbar item.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1524618-tag?language=objc for details.
func (x gen_NSToolbarItem) SetTag(
	value core.NSInteger,
) {
	C.NSToolbarItem_inst_SetTag(
		unsafe.Pointer(x.Pointer()),
		C.long(value),
	)
...
// Toolbar returns the toolbar that currently includes the item.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1532976-toolbar?language=objc for details.
func (x gen_NSToolbarItem) Toolbar() NSToolbar {
	ret := C.NSToolbarItem_inst_Toolbar(
		unsafe.Pointer(x.Pointer()),
	)
...
// Autovalidates returns a Boolean value that indicates whether the toolbar automatically validates the item.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1524463-autovalidates?language=objc for details.
func (x gen_NSToolbarItem) Autovalidates() bool {
	ret := C.NSToolbarItem_inst_Autovalidates(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetAutovalidates returns a Boolean value that indicates whether the toolbar automatically validates the item.
//
// See https://developer.apple.com/documentation/appkit/nstoolbaritem/1524463-autovalidates?language=objc for details.
func (x gen_NSToolbarItem) SetAutovalidates(
	value bool,
) {
	C.NSToolbarItem_inst_SetAutovalidates(
		unsafe.Pointer(x.Pointer()),
		convertToObjCBool(value),
	)
...
type NSToolbarRef interface {
	Pointer() uintptr
	Init_AsNSToolbar() NSToolbar
}

type gen_NSToolbar struct {
	objc.Object
}

func NSToolbar_FromPointer(ptr unsafe.Pointer) NSToolbar {
	return NSToolbar{gen_NSToolbar{
		objc.Object_FromPointer(ptr),
	}}
}

func NSToolbar_FromRef(ref objc.Ref) NSToolbar {
	return NSToolbar_FromPointer(unsafe.Pointer(ref.Pointer()))
}

// Init creates a new toolbar with an empty identifier string.
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/2873241-init?language=objc for details.
func (x gen_NSToolbar) Init() NSToolbar {
	ret := C.NSToolbar_inst_Init(
		unsafe.Pointer(x.Pointer()),
	)
...
// Init_AsNSToolbar is a typed version of Init.
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/2873241-init?language=objc for details.
func (x gen_NSToolbar) Init_AsNSToolbar() NSToolbar {
	ret := C.NSToolbar_inst_Init(
		unsafe.Pointer(x.Pointer()),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1516980-removeitematindex?language=objc for details.
func (x gen_NSToolbar) RemoveItemAtIndex(
	index core.NSInteger,
) {
	C.NSToolbar_inst_RemoveItemAtIndex(
		unsafe.Pointer(x.Pointer()),
		C.long(index),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1516979-runcustomizationpalette?language=objc for details.
func (x gen_NSToolbar) RunCustomizationPalette(
	sender objc.Ref,
) {
	C.NSToolbar_inst_RunCustomizationPalette(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(sender),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1516951-setconfigurationfromdictionary?language=objc for details.
func (x gen_NSToolbar) SetConfigurationFromDictionary(
	configDict core.NSDictionaryRef,
) {
	C.NSToolbar_inst_SetConfigurationFromDictionary(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(configDict),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1516947-validatevisibleitems?language=objc for details.
func (x gen_NSToolbar) ValidateVisibleItems() {
	C.NSToolbar_inst_ValidateVisibleItems(
		unsafe.Pointer(x.Pointer()),
	)
...
// Delegate returns the object you use to customize the toolbar contents and configuration.
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1516939-delegate?language=objc for details.
func (x gen_NSToolbar) Delegate() objc.Object {
	ret := C.NSToolbar_inst_Delegate(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetDelegate returns the object you use to customize the toolbar contents and configuration.
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1516939-delegate?language=objc for details.
func (x gen_NSToolbar) SetDelegate(
	value objc.Ref,
) {
	C.NSToolbar_inst_SetDelegate(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(value),
	)
...
// IsVisible returns a Boolean value that indicates whether the toolbar is visible.
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1516935-visible?language=objc for details.
func (x gen_NSToolbar) IsVisible() bool {
	ret := C.NSToolbar_inst_IsVisible(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetVisible returns a Boolean value that indicates whether the toolbar is visible.
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1516935-visible?language=objc for details.
func (x gen_NSToolbar) SetVisible(
	value bool,
) {
	C.NSToolbar_inst_SetVisible(
		unsafe.Pointer(x.Pointer()),
		convertToObjCBool(value),
	)
...
// ShowsBaselineSeparator returns a Boolean value that indicates whether the toolbar shows the separator between the toolbar and the main window contents.
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1516954-showsbaselineseparator?language=objc for details.
func (x gen_NSToolbar) ShowsBaselineSeparator() bool {
	ret := C.NSToolbar_inst_ShowsBaselineSeparator(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetShowsBaselineSeparator returns a Boolean value that indicates whether the toolbar shows the separator between the toolbar and the main window contents.
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1516954-showsbaselineseparator?language=objc for details.
func (x gen_NSToolbar) SetShowsBaselineSeparator(
	value bool,
) {
	C.NSToolbar_inst_SetShowsBaselineSeparator(
		unsafe.Pointer(x.Pointer()),
		convertToObjCBool(value),
	)
...
// AllowsUserCustomization returns a Boolean value that indicates whether users can modify the contents of the toolbar.
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1516962-allowsusercustomization?language=objc for details.
func (x gen_NSToolbar) AllowsUserCustomization() bool {
	ret := C.NSToolbar_inst_AllowsUserCustomization(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetAllowsUserCustomization returns a Boolean value that indicates whether users can modify the contents of the toolbar.
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1516962-allowsusercustomization?language=objc for details.
func (x gen_NSToolbar) SetAllowsUserCustomization(
	value bool,
) {
	C.NSToolbar_inst_SetAllowsUserCustomization(
		unsafe.Pointer(x.Pointer()),
		convertToObjCBool(value),
	)
...
// AllowsExtensionItems returns a Boolean value that indicates whether the toolbar can add items for Action extensions.
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1517005-allowsextensionitems?language=objc for details.
func (x gen_NSToolbar) AllowsExtensionItems() bool {
	ret := C.NSToolbar_inst_AllowsExtensionItems(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetAllowsExtensionItems returns a Boolean value that indicates whether the toolbar can add items for Action extensions.
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1517005-allowsextensionitems?language=objc for details.
func (x gen_NSToolbar) SetAllowsExtensionItems(
	value bool,
) {
	C.NSToolbar_inst_SetAllowsExtensionItems(
		unsafe.Pointer(x.Pointer()),
		convertToObjCBool(value),
	)
...
// Items an array containing the toolbar’s current items, in order.
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1516946-items?language=objc for details.
func (x gen_NSToolbar) Items() core.NSArray {
	ret := C.NSToolbar_inst_Items(
		unsafe.Pointer(x.Pointer()),
	)
...
// VisibleItems an array containing the toolbar’s currently visible items.
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1516993-visibleitems?language=objc for details.
func (x gen_NSToolbar) VisibleItems() core.NSArray {
	ret := C.NSToolbar_inst_VisibleItems(
		unsafe.Pointer(x.Pointer()),
	)
...
// AutosavesConfiguration returns a Boolean value that indicates whether the toolbar autosaves its configuration.
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1516992-autosavesconfiguration?language=objc for details.
func (x gen_NSToolbar) AutosavesConfiguration() bool {
	ret := C.NSToolbar_inst_AutosavesConfiguration(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetAutosavesConfiguration returns a Boolean value that indicates whether the toolbar autosaves its configuration.
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1516992-autosavesconfiguration?language=objc for details.
func (x gen_NSToolbar) SetAutosavesConfiguration(
	value bool,
) {
	C.NSToolbar_inst_SetAutosavesConfiguration(
		unsafe.Pointer(x.Pointer()),
		convertToObjCBool(value),
	)
...
// ConfigurationDictionary returns a dictionary containing the current configuration details for the toolbar.
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1516956-configurationdictionary?language=objc for details.
func (x gen_NSToolbar) ConfigurationDictionary() core.NSDictionary {
	ret := C.NSToolbar_inst_ConfigurationDictionary(
		unsafe.Pointer(x.Pointer()),
	)
...
// CustomizationPaletteIsRunning returns a Boolean value that indicates whether the toolbar’s customization palette is in use.
//
// See https://developer.apple.com/documentation/appkit/nstoolbar/1516987-customizationpaletteisrunning?language=objc for details.
func (x gen_NSToolbar) CustomizationPaletteIsRunning() bool {
	ret := C.NSToolbar_inst_CustomizationPaletteIsRunning(
		unsafe.Pointer(x.Pointer()),
	)
...
type NSSegmentedCellRef interface {
	Pointer() uintptr
	Init_AsNSSegmentedCell() NSSegmentedCell
}

type gen_NSSegmentedCell struct {
	objc.Object
}

func NSSegmentedCell_FromPointer(ptr unsafe.Pointer) NSSegmentedCell {
	return NSSegmentedCell{gen_NSSegmentedCell{
		objc.Object_FromPointer(ptr),
	}}
}

func NSSegmentedCell_FromRef(ref objc.Ref) NSSegmentedCell {
	return NSSegmentedCell_FromPointer(unsafe.Pointer(ref.Pointer()))
}

// DrawSegmentInFrameWithView draws the image and label of the segment in the specified view.
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500191-drawsegment?language=objc for details.
func (x gen_NSSegmentedCell) DrawSegmentInFrameWithView(
	segment core.NSInteger,
	frame core.NSRect,
	controlView NSViewRef,
) {
	C.NSSegmentedCell_inst_DrawSegmentInFrameWithView(
		unsafe.Pointer(x.Pointer()),
		C.long(segment),
		*(*C.NSRect)(unsafe.Pointer(&frame)),
		objc.RefPointer(controlView),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500204-imageforsegment?language=objc for details.
func (x gen_NSSegmentedCell) ImageForSegment(
	segment core.NSInteger,
) NSImage {
	ret := C.NSSegmentedCell_inst_ImageForSegment(
		unsafe.Pointer(x.Pointer()),
		C.long(segment),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500206-isenabledforsegment?language=objc for details.
func (x gen_NSSegmentedCell) IsEnabledForSegment(
	segment core.NSInteger,
) bool {
	ret := C.NSSegmentedCell_inst_IsEnabledForSegment(
		unsafe.Pointer(x.Pointer()),
		C.long(segment),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500177-isselectedforsegment?language=objc for details.
func (x gen_NSSegmentedCell) IsSelectedForSegment(
	segment core.NSInteger,
) bool {
	ret := C.NSSegmentedCell_inst_IsSelectedForSegment(
		unsafe.Pointer(x.Pointer()),
		C.long(segment),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500215-labelforsegment?language=objc for details.
func (x gen_NSSegmentedCell) LabelForSegment(
	segment core.NSInteger,
) core.NSString {
	ret := C.NSSegmentedCell_inst_LabelForSegment(
		unsafe.Pointer(x.Pointer()),
		C.long(segment),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500190-makenextsegmentkey?language=objc for details.
func (x gen_NSSegmentedCell) MakeNextSegmentKey() {
	C.NSSegmentedCell_inst_MakeNextSegmentKey(
		unsafe.Pointer(x.Pointer()),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500170-makeprevioussegmentkey?language=objc for details.
func (x gen_NSSegmentedCell) MakePreviousSegmentKey() {
	C.NSSegmentedCell_inst_MakePreviousSegmentKey(
		unsafe.Pointer(x.Pointer()),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500175-menuforsegment?language=objc for details.
func (x gen_NSSegmentedCell) MenuForSegment(
	segment core.NSInteger,
) NSMenu {
	ret := C.NSSegmentedCell_inst_MenuForSegment(
		unsafe.Pointer(x.Pointer()),
		C.long(segment),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500196-selectsegmentwithtag?language=objc for details.
func (x gen_NSSegmentedCell) SelectSegmentWithTag(
	tag core.NSInteger,
) bool {
	ret := C.NSSegmentedCell_inst_SelectSegmentWithTag(
		unsafe.Pointer(x.Pointer()),
		C.long(tag),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500219-setenabled?language=objc for details.
func (x gen_NSSegmentedCell) SetEnabledForSegment(
	enabled bool,
	segment core.NSInteger,
) {
	C.NSSegmentedCell_inst_SetEnabledForSegment(
		unsafe.Pointer(x.Pointer()),
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500174-setimage?language=objc for details.
func (x gen_NSSegmentedCell) SetImageForSegment(
	image NSImageRef,
	segment core.NSInteger,
) {
	C.NSSegmentedCell_inst_SetImageForSegment(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(image),
		C.long(segment),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500213-setlabel?language=objc for details.
func (x gen_NSSegmentedCell) SetLabelForSegment(
	label core.NSStringRef,
	segment core.NSInteger,
) {
	C.NSSegmentedCell_inst_SetLabelForSegment(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(label),
		C.long(segment),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500194-setmenu?language=objc for details.
func (x gen_NSSegmentedCell) SetMenuForSegment(
	menu NSMenuRef,
	segment core.NSInteger,
) {
	C.NSSegmentedCell_inst_SetMenuForSegment(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(menu),
		C.long(segment),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500188-setselected?language=objc for details.
func (x gen_NSSegmentedCell) SetSelectedForSegment(
	selected bool,
	segment core.NSInteger,
) {
	C.NSSegmentedCell_inst_SetSelectedForSegment(
		unsafe.Pointer(x.Pointer()),
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500181-settag?language=objc for details.
func (x gen_NSSegmentedCell) SetTagForSegment(
	tag core.NSInteger,
	segment core.NSInteger,
) {
	C.NSSegmentedCell_inst_SetTagForSegment(
		unsafe.Pointer(x.Pointer()),
		C.long(tag),
		C.long(segment),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500186-settooltip?language=objc for details.
func (x gen_NSSegmentedCell) SetToolTipForSegment(
	toolTip core.NSStringRef,
	segment core.NSInteger,
) {
	C.NSSegmentedCell_inst_SetToolTipForSegment(
		unsafe.Pointer(x.Pointer()),
		objc.RefPointer(toolTip),
		C.long(segment),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500202-setwidth?language=objc for details.
func (x gen_NSSegmentedCell) SetWidthForSegment(
	width core.CGFloat,
	segment core.NSInteger,
) {
	C.NSSegmentedCell_inst_SetWidthForSegment(
		unsafe.Pointer(x.Pointer()),
		C.double(width),
		C.long(segment),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500207-tagforsegment?language=objc for details.
func (x gen_NSSegmentedCell) TagForSegment(
	segment core.NSInteger,
) core.NSInteger {
	ret := C.NSSegmentedCell_inst_TagForSegment(
		unsafe.Pointer(x.Pointer()),
		C.long(segment),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500183-tooltipforsegment?language=objc for details.
func (x gen_NSSegmentedCell) ToolTipForSegment(
	segment core.NSInteger,
) core.NSString {
	ret := C.NSSegmentedCell_inst_ToolTipForSegment(
		unsafe.Pointer(x.Pointer()),
		C.long(segment),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500211-widthforsegment?language=objc for details.
func (x gen_NSSegmentedCell) WidthForSegment(
	segment core.NSInteger,
) core.CGFloat {
	ret := C.NSSegmentedCell_inst_WidthForSegment(
		unsafe.Pointer(x.Pointer()),
		C.long(segment),
	)
...
// Init initializes a new instance of the NSSegmentedCell class.
func (x gen_NSSegmentedCell) Init() NSSegmentedCell {
	ret := C.NSSegmentedCell_inst_Init(
		unsafe.Pointer(x.Pointer()),
	)
...
// Init_AsNSSegmentedCell is a typed version of Init.
func (x gen_NSSegmentedCell) Init_AsNSSegmentedCell() NSSegmentedCell {
	ret := C.NSSegmentedCell_inst_Init(
		unsafe.Pointer(x.Pointer()),
	)
...
// SegmentCount returns the number of segments in the segmented control.
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500185-segmentcount?language=objc for details.
func (x gen_NSSegmentedCell) SegmentCount() core.NSInteger {
	ret := C.NSSegmentedCell_inst_SegmentCount(
		unsafe.Pointer(x.Pointer()),
	)
...
// SetSegmentCount returns the number of segments in the segmented control.
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500185-segmentcount?language=objc for details.
func (x gen_NSSegmentedCell) SetSegmentCount(
	value core.NSInteger,
) {
	C.NSSegmentedCell_inst_SetSegmentCount(
		unsafe.Pointer(x.Pointer()),
		C.long(value),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500193-selectedsegment?language=objc for details.
func (x gen_NSSegmentedCell) SelectedSegment() core.NSInteger {
	ret := C.NSSegmentedCell_inst_SelectedSegment(
		unsafe.Pointer(x.Pointer()),
	)
...
//
// See https://developer.apple.com/documentation/appkit/nssegmentedcell/1500193-selectedsegment?language=objc for details.
func (x gen_NSSegmentedCell) SetSelectedSegment(
	value core.NSInteger,
) {
	C.NSSegmentedCell_inst_SetSelectedSegment(
		unsafe.Pointer(x.Pointer()),
		C.long(value),
	)
